...
bt_owner_active_gives = InlineKeyboardButton('Активні розіграші', callback_data='owner_active_gives')
kb_owner_menu = InlineKeyboardMarkup().add(bt_owner_active_gives)

bt_owner_change_winners = InlineKeyboardButton('Змінити переможців', callback_data='owner_change_winners')
