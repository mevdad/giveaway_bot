...
bt_admin_add_group_for_channel = InlineKeyboardButton('Додати групу', callback_data='admin_add_group')
bt_admin_delete_channel = InlineKeyboardButton('Видалити канал', callback_data='admin_delete_channel')
