...
async def show_give_statistic(
    ...
    if statistic_info:
        await jam.message.edit_text(
            f'➖  <b>Кількість учасників за останні 24 години:</b> {statistic_info.count_members_in_24_hours}\n➖  <b>Загальна кількість учасників:</b> {statistic_info.count_members_summary}',
            reply_markup=kb_admin_cancel_action
        )

    else:
        await jam.answer('У розіграші немає учасників')
