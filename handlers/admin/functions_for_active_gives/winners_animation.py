...
async def run_winners_animation(
    ...
    if len(members_from_giveaway) >= winners_count:
        ...
        await bot.send_message(
            chat_id=channel_id,
            text=f'<b>💎 Початок вибору переможця через 10 хвилин</b>',
            reply_markup=markup
        )
        ...
        if temporary_users_for_watch_results:
            ...
            for user in temporary_users_for_watch_results:
                ...
                message = await bot.send_message(
                    ...
                    text='💎  <b>Починається вибір переможц</b>'
                )
        ...
        await bot.send_message(
            chat_id=channel_id,
            text=f'<b>🚫  Розіграш завершено, вибрати переможців не вдалося, учасників занадто мало</b>',
        )
